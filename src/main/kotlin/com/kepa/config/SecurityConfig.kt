...
class SecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
       http.httpBasic().disable()
           ...
           .antMatchers("/api/withdraw").hasAnyAuthority(Role.ADMIN.name,Role.SUPER_ADMIN.name,Role.TRAINER.name,Role.USER.name)
           .antMatchers("/api/token").hasAnyAuthority(Role.ADMIN.name,Role.SUPER_ADMIN.name,Role.TRAINER.name,Role.USER.name)
           .antMatchers("/api/logout").hasAnyAuthority(Role.ADMIN.name,Role.SUPER_ADMIN.name,Role.TRAINER.name,Role.USER.name)
           .antMatchers("/**")
           .permitAll()
